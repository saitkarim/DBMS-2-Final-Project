...
public class HuaweiController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        File file = new File("images/huawei_icon.jpg");
        ...
        try {
            ...
            String query = "SELECT brand, laptop_name, display_size, processor_type, graphics_card, disk_space FROM laptops WHERE brand = 'Huawei'";

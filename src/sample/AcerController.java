...
public class AcerController implements Initializable {
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            String query = "SELECT brand, laptop_name, display_size, processor_type, graphics_card, disk_space FROM laptops WHERE brand = 'Acer'";
